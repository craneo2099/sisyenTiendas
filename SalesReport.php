...
if(isset($_POST['PeriodFrom']) AND isset($_POST['PeriodTo']) AND !$_POST['NewReport']) {
	...
	echo '<div class="onlyprint printHeader">
	<div class="logoPrint" ><img src="', $RootPath, '/css/', $_SESSION['Theme'], '/images/company.png"/></div>
	<div class="companyPrint" >', stripslashes($_SESSION['CompanyRecord']['coyname']),'</div>
	</div>';
