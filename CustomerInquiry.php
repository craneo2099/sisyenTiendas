...
echo '<p class="page_title_text">
		<img src="', $RootPath, '/css/', $Theme, '/images/customer.png" title="', _('Customer'), '" alt="" />',
		 _('Customer'), ': ', stripslashes($CustomerID), ' - ', $CustomerRecord['name'], '<br />', 
		 _('All amounts stated in'), ': ', $CustomerRecord['currency'], '<br />',
		  _('Terms'), ': ',	  _($CustomerRecord['terms']), '<br />
	</p>';
