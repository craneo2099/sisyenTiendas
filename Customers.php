...
// Show Sales Type drop down list
	if ($typecount==0){
		$DataError =1;
		echo '<tr>
				<td colspan="2">' . getSalesTypesSelect() . '<br /><a href="SalesTypes.php?" target="_parent">' . _('Setup Types') . '</a></td>
			</tr>';
	} else {
        echo '<tr>
				<td>' . _('Sales Type') . '/' . _('Price List') . ':</td>
			   <td>';
			   $atts='tabindex="9" required="required">';
			   getSalesTypesSelect('',$atts);
        echo '</td>
			</tr>';
	}
