...
$Title=_('Add or Update Prices Based On Costs');
...
echo '<br /><table class="selection">
             <tr>
               ...
               <td>';
			   getSalesTypesSelect($_POST['SalesType'],'','','',1);

echo '</td></tr>';

echo '<tr>
		<td>' . _('Price list currency') . ':</td>
...
if (isset($_POST['CostType']) and $_POST['CostType']=='OtherPriceList'){
     ...
     echo '<tr><td>' . _('Select the Base Price List to Use') . ':</td>
                            <td>';
	$atts='name="BasePriceList"';
	getSalesTypesSelect($_POST['BasePriceList'],$atts,'','',1);
...
if (isset($_POST['UpdatePrices'])){
	...
	if ($_POST['CostType']=='OtherPriceList' AND $_POST['BasePriceList']==$_POST['SalesType']){
	...
	if ($InputError==0) {
		...
		echo '<br />' . _('So we are using a price list/sales type of') .' : ' . $_POST['SalesType'];
