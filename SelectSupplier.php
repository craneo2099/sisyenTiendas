...
if (isset($_POST['Select'])) { /*User has hit the button selecting a supplier */
	...
	if(isset($_SESSION['lastPage'])){
		if($_SESSION['lastPage']=='reversegrn'){
			header('location:' . $RootPath . '/ReverseGRN.php');
		}
	}
}
...
if (isset($_SESSION['SupplierID'])) {
	...
	<br /><a href="' . $RootPath . '/Suppliers.php?SupplierID=' . $_SESSION['SupplierID'] . '&action=dodelete">' . _('Delete Supplier') . '</a>
