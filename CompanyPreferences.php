...
echo '<tr>
		...
		<td><input type="hidden" value="MXN"  id="CurrencyDefault" name="CurrencyDefault"/>
		Peso mexicano
		</td>
	</tr>';
...
echo '<tr>
		<td></td>
		<td><input type="hidden" value="0" name="GLLink_Debtors"/></td>
		<input type="hidden" value="0" name="GLLink_Creditors"/>
