...
if (isset($SelectedLabelID)) {
	...
	echo '<table class="selection">
				...
				<td><table>
					<tr>
						<th>' . _('Field') . '</th>
						<th>' . _('Position') . '<br />' . _('Vertical')  . '<br />(PosV)</th>
						<th>' . _('Position') . '<br />' . _('Horizontal') . '<br />(PosH)</th>
						<th>' . _('Font Size') . '</th>
						<th>' . _('Bar-code') . '</th>
					</tr>';
	if (DB_num_rows($result)>0){
