...
$Title = _('Change A Stock Category Code');// Screen identificator.
...
echo '<br />
	<table>
		<tr>
			...
			<td><input type="text" data-type="no-illegal-chars" name="OldStockCategory" required="required"
			title="' . _('Enter up to six alphanumeric characters or underscore as a code for this stock category') . '" 
			size="7" maxlength="6" /></td>
		</tr>
		<tr>
			<td>' . _('New Inventory Category Code') . ':</td>
			<td><input type="text" data-type="no-illegal-chars" required="required"
			title="' . _('Enter up to six alphanumeric characters or underscore as a code for this stock category') . '" 
			name="NewStockCategory" size="7" maxlength="6" /></td>
		</tr>
	</table>
