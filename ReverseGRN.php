...
if (!isset($_POST['SupplierID']) or $_POST['SupplierID'] == "") {
	...
	echo '<meta http-equiv="Refresh" content="0; url=' . $RootPath . '/SelectSupplier.php?who=reversegrn">';
	exit;
...
if (isset($_GET['GRNNo']) and isset($_POST['SupplierID'])) {
	...
	echo '<td>' . _('Show all goods received after') . ': </td>
		...
		<br />
		<div class="centre">
			<input type="submit" name="ShowGRNS" value="' . _('Search') . '" />
		</div>
		</div>
	</form>';
...
echo '<br />
<a href="'.$RootPath.'/SelectSupplier.php?who=reversegrn">' . _('Select Supplier') . '</a>';
include ('includes/footer.php');
?>
